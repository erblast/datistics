...
blogdown::shortcode("image"
                    , classes = 'center'
                    , src = '../../../easyalluvial_logo_square.png'
                    , thumbnail = '../../../easyalluvial_logo_square.png'
                    , `thumbnail-width` = '360px'
                    , `thumbnail-height` = '360px'
                    , target = 'https://github.com/erblast/easyalluvial'
                    )
...
[github repository](https://github.com/erblast/easyalluvial)

## Features
- plot alluvial graph with a single line of code of a given datafram
